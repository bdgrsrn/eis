...
import Ribbon from "./view/ReactBootstrapRibbon";
import RibbonGroup from "./view/ReactBootstrapRibbonGroup";
import RibbonGroupItem from "./view/ReactBootstrapRibbonGroupItem";
import RibbonButton from "./view/ReactBootstrapRibbonButton";
...
const RibbonView = () => {
    ...
    return (
        <Ribbon breakpoint="sm">
            ...
            <RibbonGroup title={t('Lang.1')} colClass="col-2">
                <RibbonGroupItem colClass="col-12">
                    <div className="row">
                        <RibbonGroupItem colClass="col-12">
                            <RibbonButton onClick={() => handleClick('en')}>
                        ...
                        <RibbonGroupItem colClass="col-12">
                            <RibbonButton  onClick={() => handleClick('mn')}>
